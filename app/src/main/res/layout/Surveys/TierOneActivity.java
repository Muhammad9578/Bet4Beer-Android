...
public class TierOneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tier_one);
        init();
    ...
    private void init() {
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TierOneActivity.this,TierTwoActivity.class);
                startActivity(intent);
                Toast.makeText(TierOneActivity.this, "Next", Toast.LENGTH_SHORT).show();
            }
        });
...
// for example:
        ...
        animation.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                Toast.makeText(TierOneActivity.this, "Time Completed", Toast.LENGTH_SHORT).show();
            }
