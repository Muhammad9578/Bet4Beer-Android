...
public class CreditsRemainingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_credits_remaining);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CreditsRemainingActivity.super.onBackPressed();
            }
        });
    }
    ...
    private void initAdapter() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(CreditsRemainingActivity.this);
        linearLayoutManager.setOrientation(RecyclerView.VERTICAL);
        credits_receivedrv.setLayoutManager(linearLayoutManager);

        pAdapter = new CreditsAdapter(CreditsRemainingActivity.this, creditsModel, codes);
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                u1 = ob.getString("redeemed_quantity");

                                remaining = Integer.parseInt(quantity1) - Integer.parseInt(u1);
